                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">회원 Table</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    	<c:forEach var="member" items="${T2member}" varStatus="status">
	                                        <tr>
	                                            <td>${member.id}</td>
	                                            <td>${member.rank}</td>
	                                            <td>${Id_totalCountPurchaseList.get(status.index)}</td>
	                                            <td>${Id_totalPurchasePriceList.get(status.index)}</td>
	                                            <td>${Id_totalCountSalesList.get(status.index)}</td>
	                                            <td>${Id_totalSalesPriceList.get(status.index)}</td>
	                                        </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
