...
<script type="text/javascript">
	...
	$(document).ready(function() {
		// 웹소켓을 지정한 url로 연결한다.
		console.log("===========================================")
		var ws = new WebSocket("ws://192.168.0.76:8080/web/echo.do");
		socket = ws;
		...
		ws.onopen = function() {
			...
			$("#sendBtn").click(function() {
				if($('#message').val() != ""){
					ws.send("310!%/"+name +"!%/"+$('#message').val()+"!%/"+roomId);
						...
						<!-- 
						 ...
						 <c:if test="${roomList != null }">
						 	<c:forEach var="memberRoom" items="${roomList }" varStatus="status">
						 		<div class="chat_people" style=" cursor: pointer;" onclick="location.href='/web/chat/moveMRoom.do?roomId=${memberRoom.room_id}';">
									<div class="chat_img">
										<img src="<c:url value="/resources/images2/user-profile.png" />"alt="sunil">
									</div>
									<div class="chat_ib">
