package main.project.web.purchase;
...
public class PaymentCheck { 
	...
	public static final String KEY = "0933999968731113"; //아임포트 Rest Api key
	public static final String SECRET = "3ukFMSnSNKeJJ9HnXuL5CWsoJUYdidfmHA1uspmf9AYTKFgIa1ONXgcHbaUtn9Q5JSzchWsrxqki6B0g"; //아임포트 Rest Api Secret 
	...
	// 결제취소 
	public int cancelPayment(String token, String mid, String reason) { 
		HttpClient client = HttpClientBuilder.create().build(); 
		HttpPost post = new HttpPost(IMPORT_CANCEL_URL); 
		Map<String, String> map = new HashMap<String, String>(); 
		post.setHeader("Authorization", token); 
		map.put("merchant_uid", mid);  // 주문번호
		map.put("reason",reason); // 취소사유
		String asd = ""; 
		try { 
